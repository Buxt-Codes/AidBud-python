...
class embedder:
    ...
    def _chunk_text(self, text: str, max_tokens: int = None, overlap: int = 50) -> List[str]:
    ...
    def _chunk_response(self, response: Dict[str, str], max_tokens: int = None, overlap: int = 50) -> List[str]:
        if max_tokens is None:
            max_tokens = self.max_token_length
    ...
    def _chunk_attachment(self, attachment: Dict[str, Any], max_tokens: int = None, overlap: int = 50) -> List[str]:
        if max_tokens is None:
            max_tokens = self.max_token_length
    ...
    def embed_response(self, response: Dict[str, str]) -> List[List[float]]:
    ...
    def embed_attachments(self, attachment: Dict[str, Any]) -> List[List[float]]:
